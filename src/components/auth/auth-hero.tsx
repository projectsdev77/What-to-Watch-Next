 ...
 * steel split from the redesign mocks. The mocks' left panel is a
 * drop-in photo slot from the design tool — there's no real
 * photography asset pipeline for this app, so it's rendered here as a
 * gradient field instead of a placeholder image.
 */
